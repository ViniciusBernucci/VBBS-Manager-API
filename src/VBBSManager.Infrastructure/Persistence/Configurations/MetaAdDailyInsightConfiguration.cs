...
public class MetaAdDailyInsightConfiguration : IEntityTypeConfiguration<MetaAdDailyInsight>
{
    public void Configure(EntityTypeBuilder<MetaAdDailyInsight> builder)
    {
        ...
        builder.Property(x => x.AdId).HasMaxLength(50).IsRequired();
        builder.Property(x => x.AdName).HasMaxLength(500).IsRequired();
        ...
        builder.HasIndex(x => new { x.TenantId, x.AdId, x.Date }).IsUnique();
